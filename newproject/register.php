         ...
         if(isset($_POST['submit'])){
            ...
            if(mysqli_num_rows($verify_username_query) != 0){
                echo "<div class='message'>
                          <p>This username is taken, please choose another one!</p>
                      </div> <br>";
                echo "<a href='javascript:self.history.back()'><button class='btn'>Go Back</button>";
            } elseif(mysqli_num_rows($verify_email_query) != 0){
                echo "<div class='message'>
                          <p>This email is already in use, please use another one!</p>
                      </div> <br>";
                echo "<a href='javascript:self.history.back()'><button class='btn'>Go Back</button>";
            } else {
